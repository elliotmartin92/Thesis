...
```{r, out.width="97%", include=TRUE, fig.align="center", fig.cap='(ref:book-F1)', fig.scap='(ref:book-F1-short)', echo=FALSE}
# 6*(3.59/7.07)
...
```{r, include=TRUE, out.width="97%", fig.align="center", fig.cap='(ref:book-F2)', fig.scap='(ref:book-F2-short)', echo=FALSE}
# 6*(2.04/8.25)
